    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?= form_error('form/update_sj_CHECKOUT','<div class="alert alert-danger" role="alert">', '
                ...
                <?php endforeach; ?>
                <a href="" class="badge badge-success mb-3" data-toggle="modal" data-target="#newSpkItemModal">Add SJ CheckOUT</a>
                <a type="button" class="badge badge-warning mb-3"  href="<?=base_url('warehouse/index_checkout')?>" name="btn_add" style="margin:auto;">Back to CheckOUT</a>                    
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $po['to_dept']?></td>
                        <td>
                            <a class="badge badge-warning mb-3"  href="<?=base_url('warehouse/sj_detail_item_checkout/'.$po['id_spk'] . '/' . $po['id_sj'])?>" name="btn_add" style="margin:auto;">Detail Item</a>
                            <a href="<?= base_url('form/delete_spk_item/'.$po['id_sj'])?>" name="btn-delete" class="badge badge-danger">delete</a>
