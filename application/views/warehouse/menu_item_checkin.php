                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('form/delete_sj/'.$po['id_sj'])?>" name="btn-delete" class="badge badge-danger">delete</a>
            ...
            <form action="<?= base_url('warehouse/update_sj_item/'.$sp['id_spk']);?>" method="post">
                ...
                <input type="hidden" name="artcolor_name" value="<?= $sp['artcolor_name']; ?>">
                        ...
                        <div class="form-group" style="display:inline-block;">
                            ...
                            <input type="text" name="no_sj" style="width:90%;margin-right: px;" class="form-control" id="no_sj" placeholder="NO SJ">
                        </div>
                        <div class="form-group" style="display:inline-block;">
                            <label for="tgl_checkin" style="width:87%;margin-left: 0px;">Tanggal Checkin</label>
                            <input type="date" name="tgl_checkin" style="width: 90%;margin-right: 0px;margin-left: px;" class="form-control" id="tgl_checkin" placeholder="Tanggal Checkin">
                        </div>
                        <div class="form-group" style="display:inline-block;">
                            <label for="supplier_name" style="width:87%;margin-left: 0px;">Nama Suplier</label>
                            <input type="text" name="supplier_name" style="width: 90%;margin-right: 0px;margin-left: px;" class="form-control" id="supplier_name" placeholder="Nama Supplier">
                        </div>
                        <div class="form-group" style="display:inline-block;">
                            <label for="no_plat" style="width:87%;margin-left: 0px;">Nomor Plat</label>
                            <input type="text" name="no_plat" style="width: 90%;margin-right: 0px;margin-left: px;" class="form-control" id="no_plat" placeholder="Nomor Plat">
                        </div>
                </div>
