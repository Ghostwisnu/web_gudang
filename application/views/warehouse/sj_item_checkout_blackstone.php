    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?= form_error('form/sj_item_checkout_blackstone','<div class="alert alert-danger" role="alert">', '
                ...
                <?php endforeach; ?>
                <a href="" class="badge badge-success mb-3" data-toggle="modal" data-target="#newSjItemModal">Add Item CheckOUT</a>
                ...
                <a href="<?= base_url('warehouse/export_sj_checkout_blackstone_pdf/' . $sp['id_spk'] . '/' . $sj['id_sj']); ?>" class="badge badge-danger mb-3" target="_blank">Export to PDF</a>                
