        ...
        <div class="col-lg-12">
            ...
            <?= form_error('form/view_spk_ariat','<div class="alert alert-danger" role="alert">', '
                ...
                <?php foreach($spk as $sp): ?>
                    ...
                    <a type="button" class="badge badge-success"  href="<?=base_url('form/update_spk_item/'.$sp['id_spk'])?>" name="btn_add" style="margin:auto;">Add New Item</a>
                <?php endforeach; ?>
                <a href="" class="badge badge-success" data-toggle="modal" data-target="#newSpkSizeModal">Add New SPK Size</a>
