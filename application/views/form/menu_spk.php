    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?= form_error('form/spk','<div class="alert alert-danger" role="alert">', '
                ...
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newSpkModal">Add New SPK</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $po['total_qty'];?></td>
                        <td>
                            <a type="button" class="badge badge-success"  href="<?=base_url('form/update_spk_size_brand/'.$po['id_spk'])?>" name="btn_add" style="margin:auto;">Add New Size</a>
