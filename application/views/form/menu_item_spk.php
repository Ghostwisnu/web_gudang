    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?= form_error('form/update_spk_item','<div class="alert alert-danger" role="alert">', '
                ...
                <a type="button" class="badge badge-success"  href="<?=base_url('form/update_spk_size_brand/'.$sp['id_spk'])?>" name="btn_add" style="margin:auto;">Add New Size</a>
                <a type="button" class="badge badge-success"  href="<?=base_url('form/view_report_spk_brand/'.$sp['id_spk'])?>" name="btn_add" style="margin:auto;">Menu Report</a>
                <?php endforeach; ?>
                <a href="" class="badge badge-success" data-toggle="modal" data-target="#newSpkItemModal">Add New SPK Item</a>
                <a type="button" class="badge badge-warning"  href="<?=base_url('form/spk')?>" name="btn_add" style="margin:auto;">Back to SPK</a>                    
