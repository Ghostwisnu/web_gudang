    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?= $this->session->flashdata('message'); ?>
                ...
                <a class="badge badge-success mb-3" href="<?= base_url('form/update_spk_item/' . $sp['id_spk']) ?>">Add New Item</a>
            <?php endforeach; ?>
            <a class="badge badge-success mb-3" data-toggle="modal" data-target="#newSpkSizeModal">Add New SPK Size</a>
            <a class="badge badge-warning mb-3" href="<?= base_url('form/spk') ?>">Back to SPK</a>                  
